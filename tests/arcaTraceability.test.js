...
describe('ARCA certificate traceability', () => {
  ...
  test('scores CUIT, species, campaign and close dates as evidence', () => {
    const evidence = baseEvidence(
      { cuit_productor: '30-71018399-2', especie_nombre: 'Soja', campana_desc: '2025/2026', fecha_emision: '2026-03-05' },
      { participant_cuits: ['30710183992'], document_date: '2026-03-03', payload: { especie: 'SOJA', campana: '2025/2026' } }
    );
